...
import noShortformMethods from './rules/no-shortform-methods.js';

const pluginTjwBase = {
  meta: {
    name: 'eslint-plugin-base-tjw',
    version: '4.0.0'
  },
  configs: {},
  rules: {
    'no-shortform-methods': noShortformMethods
  }
};

Object.assign(pluginTjwBase.configs, {
  recommended: {
    languageOptions: {
      globals: {
        ...globals.browser,
    ...
    rules: {
      ...
      // { foo: function () {} } not { foo() {} }
      'base-tjw/no-shortform-methods': 'error',
      // if (a) { a++ } not if (a) a++
      curly: [
        'error'
      ],
